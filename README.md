...
<!-- TODO: record a 2-min walkthrough (script in docs/DEMO_SCRIPT.md) and paste the Loom link here:
...
- 🚀 **Live, explainable demo** — probability + verdict + SHAP, deployed on Hugging Face Spaces
- 🧠 **Dual-XAI fusion build** — both subsystems live: LightGBM **+ LSTM** → 3-way *Normal / Fraud / Expert-Checking* verdict, explained by **SHAP (tree) and LIME (LSTM)** side by side (`Dockerfile.fusion`)
